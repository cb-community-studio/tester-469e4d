    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="flex w-10">
                ...
                <div className='col-12 lg:col-6 xl:col-4'><Link to='/items'><div className='card mb-0 flex flex-column align-items-center justify-content-center hover zoom' style={{ height: '10rem' }}><div className='text-900 font-medium text-lg'>Items</div></div></Link></div>
                ...
                <div className='col-12 lg:col-6 xl:col-4'><Link to='/test1'><div className='card mb-0 flex flex-column align-items-center justify-content-center hover zoom' style={{ height: '10rem' }}><div className='text-900 font-medium text-lg'>Test1</div></div></Link></div>
                <div className='col-12 lg:col-6 xl:col-4'><Link to='/test2'><div className='card mb-0 flex flex-column align-items-center justify-content-center hover zoom' style={{ height: '10rem' }}><div className='text-900 font-medium text-lg'>Test2</div></div></Link></div>
