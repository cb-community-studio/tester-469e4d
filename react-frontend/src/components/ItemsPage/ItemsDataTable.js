...
const ItemsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="orderID" header="OrderID" body={pTemplate0} style={{ minWidth: "8rem" }} />
            <Column field="ProductID" header="Product ID" body={pTemplate1} style={{ minWidth: "8rem" }} />
            <Column field="Quantity" header="Quantity" body={inputTemplate2} style={{ minWidth: "8rem" }} />
